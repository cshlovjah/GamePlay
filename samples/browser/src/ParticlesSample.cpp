...
void ParticlesSample::updateFrames()
{
    ...
    unsigned int fc = (unsigned int)strtol(cBox->getText(), NULL, 10);
    unsigned int w = (unsigned int)strtol(wBox->getText(), NULL, 10);
    unsigned int h = (unsigned int)strtol(hBox->getText(), NULL, 10);
